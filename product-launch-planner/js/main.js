var appcuesProductLaunchPlanner = {
	...
	sendHubSpotData: function(emailAddress) {
		...
		var hubspotCookie = appcuesProductLaunchPlanner.getCookie('hubspotutk');
		...
		$("#next-button").click(function(){
			...
			if (targetInput.find('input').attr('id') === "input-email"){
				...
				if(appcuesProductLaunchPlanner.validateEmail(targetEmail)) {
					appcuesProductLaunchPlanner.sendHubSpotData(targetEmail);
